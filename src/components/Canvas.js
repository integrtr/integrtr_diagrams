...
import {useShapes, clearSelection, createCircle, createRectangle, saveDiagram, reset} from "./state";
...
export function Canvas() {
	...
	return (
		<main className="canvas" onDrop={handleDrop} onDragOver={handleDragOver}>
			...
			<Stage ref={stageRef} width={window.innerWidth - 400} height={window.innerHeight} onClick={clearSelection}>
				<Layer>
